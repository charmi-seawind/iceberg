...
import productbanner from "../../assets/product/productbanner.jpg"
      ...
      <div className="relative h-full w-full">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-4xl">
            Innovative Technology Solutions for Every Industry
          </h1>

          <p className="mt-6 max-w-2xl text-lg text-white/80">
            Discover our comprehensive range of interactive displays, smart devices, and hardware solutions designed to enhance productivity and engagement.
          </p>
        </motion.div>
