...
import certi3 from "../../assets/certificate/certi3.avif";
import certi4 from "../../assets/certificate/certi4.avif";
...
const CertificationData = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="bg-white py-10 sm:py-12 md:py-10  font-sans"
    >
      <Container>
        <div className="">
          <motion.h1
